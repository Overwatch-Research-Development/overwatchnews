...
function Index() {
  ...
  return (
    <div className="relative flex h-full w-full flex-col bg-card">
      {/* Navigation */}
      <div className="sticky top-0 z-50 mx-auto flex w-full max-w-(--breakpoint-lg) items-center justify-between p-6 py-3">
      ...
      {/* Content */}
      <div className="z-10 mx-auto flex w-full max-w-(--breakpoint-lg) flex-col gap-4 px-6">
        <div className="z-10 flex h-full w-full flex-col items-center justify-center gap-4 p-12 md:p-24">
          <Button
            variant="outline"
            className={cn(
              "hidden h-8 rounded-full bg-white/40 px-3 text-sm font-bold backdrop-blur-sm hover:text-primary dark:bg-secondary md:flex",
            )}
          >
          ...
          <p className="max-w-(--breakpoint-md) text-center text-lg leading-normal! text-muted-foreground md:text-xl">
        ...
        <div className="relative z-10 flex flex-col border border-border backdrop-blur-xs lg:flex-row">
        ...
        <div className="z-10 flex h-full w-full flex-col items-center justify-center gap-6 p-12">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="hidden h-10 select-none items-center gap-2 rounded-full bg-green-500/5 px-2 py-1 pr-2.5 text-base font-medium tracking-tight text-green-600 ring-1 ring-inset ring-green-600/20 backdrop-blur-xs dark:bg-yellow-800/40 dark:text-yellow-100 dark:ring-yellow-200/50 md:flex"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
